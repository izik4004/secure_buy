...
<div class="md:container mx-auto">
  ...
  <div class="md:container lg:px-20 md:px-6 px-4 md:py-12 py-8">
    <div>
      <h1 class="text-3xl lg:text-3xl font-semibold text-gray-800 dark:text-white text-center">Top Selling</h1>
    </div>
